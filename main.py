        ...
        if week == 0 or week == 10:
            ...
            if screen_idx == 0:
                ...
                if displaying_warning > 0:
                    if displaying_warning == 4:
                        # special case for score reset
                        draw_warning(
                            window,
                            "You've taken a break to reset and starting your semester fresh and ready to go! Your scores have been reset.",
                            "GOT IT",
                        )
                        for event in pygame.event.get():
                            if event.type == pygame.KEYDOWN:
                                if (
                                    ...
                                    displaying_warning = 0
                    else:
                        warning_key = list(category_scores.keys())[
                        ...
                        if (
                            ...
                            draw_warning(
                                ...
                                warnings[warning_key][
                                    category_warning_count[warning_key]
                                ],
                                "GOT IT",
                            )
                            for event in pygame.event.get():
